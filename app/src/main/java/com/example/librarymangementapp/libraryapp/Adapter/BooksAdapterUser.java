 ...
 */
public class BooksAdapterUser extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
   ...
   // RealmResults<Book> books;
    ...
    public BooksAdapterUser(Context context, RealmResults<Book> bookUserListItems){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.layout_display_books_user, viewGroup, false);
